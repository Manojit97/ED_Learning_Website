...
const ExploreMore = () => {
  ...
  return (
    <div>
      ...
      {/* Sub-Heading text */}
      <p className='text-center text-[#838894]  text-lg font-semibold mt-3 mb-3 lg:mb-0 '>
        Learn to build anything you can imagine
      </p>  

      {/*Tabs div */}
      <div className=' hidden lg:flex mt-5 shadow-custom  flex-row rounded-full gap-2
       bg-[#161D29] mb-5 border-[#AFB2BF] p-1'>
      {
        tabsName.map( (element, index) => {
            return (
                ...
                hover:bg-[#000814] hover:text-[#F1F2FF] px-8 py-2`}
                key={index}
